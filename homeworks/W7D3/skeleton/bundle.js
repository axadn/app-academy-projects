...
exports.fetchSearchGiphys = exports.recieveSearchGiphys = exports.REQUEST_SEARCH_GIPHYS = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
var recieveSearchGiphys = exports.recieveSearchGiphys = function recieveSearchGiphys(giphys) {
  return {
...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return function (dispatch) {
    APIUtil.fetchSearchGiphys(searchTerm).then(function (result) {
      return dispatch(recieveSearchGiphys(result.data));
    });
  };
};
  ...
  return _react2.default.createElement(
    ...
    giphys.map(function (giphy, idx) {
      return _react2.default.createElement(
        'li',
        { key: 'img' + idx },
        _react2.default.createElement('img', { src: giphy.images.original.url })
      );
    })
  );
};
...
var GiphysSearch = function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleChange(key) {
      ...
      return function (e) {
        _this2.setState(_defineProperty({}, key, e.currentTarget.value));
      };
    }
  }, {
    key: 'render',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Query',
            _react2.default.createElement('input', { type: 'text', onChange: this.handleChange("searchTerm"),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchSearchGiphys: function fetchSearchGiphys(searchTerm) {
      dispatch((0, _giphy_actions.fetchSearchGiphys)(searchTerm));
    }
  };
};
